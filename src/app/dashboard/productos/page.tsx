        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {products.map(p => (
                <tr key={p.id} className="hover:bg-gray-50">
                  ...
                  <td className="table-cell">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${p.isActive ? "bg-emerald-100 text-emerald-700" : "bg-gray-100 text-gray-500"}`}>
                      {p.isActive ? "Activo" : "Inactivo"}
                    </span>
                  </td>
                  <td className="table-cell">
                    <div className="flex gap-1">
                      <button onClick={() => openEdit(p)} className="p-1.5 hover:bg-indigo-50 rounded-lg" title="Editar">
                        <Pencil className="w-4 h-4 text-indigo-600" />
                      </button>
                      <button onClick={() => handleDelete(p.id)} className="p-1.5 hover:bg-red-50 rounded-lg" title="Desactivar">
              ...
              {products.length === 0 && (
                <tr><td colSpan={8} className="table-cell text-center text-gray-400 py-12">No se encontraron productos</td></tr>
              )}
            </tbody>
          </table>
        </div>
