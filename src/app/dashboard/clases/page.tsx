    ...
    <div className="space-y-6">
      ...
      >
        <form onSubmit={handleCreateClass} className="space-y-4">
          <div>
            <label htmlFor="class-name" className="block text-sm font-medium text-gray-700 mb-1">Nombre *</label>
            <input
              id="class-name"
          ...
          <div>
            <label htmlFor="class-desc" className="block text-sm font-medium text-gray-700 mb-1">Descripción</label>
            <input
              id="class-desc"
              className="input-field"
          ...
          <div>
            <label htmlFor="class-trainer" className="block text-sm font-medium text-gray-700 mb-1">Entrenador</label>
            <select
              id="class-trainer"
              className="input-field"
          ...
          <div>
            <label htmlFor="class-day" className="block text-sm font-medium text-gray-700 mb-1">Día de la semana</label>
            <select
              id="class-day"
              className="input-field"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="class-start" className="block text-sm font-medium text-gray-700 mb-1">Hora inicio</label>
              <input
                id="class-start"
                type="time"
                className="input-field"
            ...
            <div>
              <label htmlFor="class-end" className="block text-sm font-medium text-gray-700 mb-1">Hora fin</label>
              <input
                id="class-end"
                type="time"
                className="input-field"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="class-capacity" className="block text-sm font-medium text-gray-700 mb-1">Capacidad máxima</label>
              <input
                id="class-capacity"
                type="number"
                min="1"
            ...
            <div>
              <label htmlFor="class-room" className="block text-sm font-medium text-gray-700 mb-1">Sala</label>
              <input
                id="class-room"
                className="input-field"
      ...
      >
        {selectedClass && (
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-700 mb-2">Inscritos</h3>
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`p-1.5 rounded-lg transition-colors ${
                            e.status === "ATTENDED" ? "btn-success" : "bg-gray-200 hover:bg-emerald-100"
                          }`}
                          title="Asistió"
                        >
