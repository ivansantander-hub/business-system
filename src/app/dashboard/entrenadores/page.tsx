    ...
    <div className="space-y-6">
      ...
      {trainers.length === 0 ? (
        <div className="card text-center py-12">
          <p className="text-gray-400">No hay entrenadores registrados</p>
              ...
              <div key={trainer.id} className="card">
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-700">Clases que imparte</span>
                    <Link
                  ...
                  {trainerClasses.length === 0 ? (
                    <p className="text-sm text-gray-400">Sin clases asignadas</p>
                  ) : (
