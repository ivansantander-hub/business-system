  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3"><Truck className="w-7 h-7 text-indigo-600" /><h1 className="text-2xl font-bold text-gray-900">Proveedores</h1></div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              ...
              {suppliers.length === 0 && <tr><td colSpan={6} className="table-cell text-center text-gray-400 py-12">Sin proveedores</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
      ...
      <Modal open={showModal} onClose={() => setShowModal(false)} title={editing ? "Editar Proveedor" : "Nuevo Proveedor"}>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Contacto</label><input className="input-field" value={form.contactName} onChange={e => setForm({...form, contactName: e.target.value})} /></div>
